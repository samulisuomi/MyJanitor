	...
	var glDatePicker = (function() {
		...
		glDatePicker.prototype =
		{
			...
			render: function(renderCalback) {
				...
				var dowNames = options.dowNames || [ 'Su', 'Ma', 'Ti', 'Ke', 'To', 'Pe', 'La' ];
				var monthNames = options.monthNames || [ 'Tammikuu', 'Helmikuu', 'Maaliskuu', 'Huhtikuu', 'Toukokuu', 'Kesäkuu', 'Heinäkuu', 'Elokuu', 'Syyskuu', 'Lokakuu', 'Marraskuu', 'Joulukuu' ];
